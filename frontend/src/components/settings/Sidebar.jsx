            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 si-accent-bg rounded-xl"
                  style={{ borderLeft: "2px solid rgb(var(--si-accent))" }}
                  transition={{ type: "spring", stiffness: 380, damping: 30 }}
                />
              )}
              <span className={`relative z-10 ${isActive ? "si-accent-text" : "text-slate-400"}`}>
