...
import { Lock, LogIn, ArrowLeft, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#090a0f] text-slate-100 flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans select-none">
      ...
      >
        ...
        <h2 className="text-lg font-bold text-slate-300">Your session has expired</h2>
        <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
          Your session is no longer valid. Sign in again or try refreshing your session if you
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row gap-3 mt-8 relative z-10 w-full max-w-md justify-center"
      >
        <button
        ...
        <button
          ...
          disabled={refreshing}
          className="h-10 px-5 rounded-xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] text-slate-300 hover:text-white transition flex items-center justify-center gap-2 text-xs font-semibold disabled:opacity-50"
        >
