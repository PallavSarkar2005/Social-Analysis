...
export default function Error404() {
  ...
  return (
    <div className="min-h-screen bg-[#090a0f] text-slate-100 flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans select-none">
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight">404</h1>
        <h2 className="text-lg font-bold text-slate-300">Page Not Found</h2>
        <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
          The leader, index telemetry node, or page you are querying does not exist or has been deleted from our database registry.
        </p>
      </motion.div>
